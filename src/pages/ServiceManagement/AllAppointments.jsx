...
<SearchBar Search={(e) => setSearch(e.target.value)}/>
    ...
    (appointment.userId.First_name && appointment.vendorId.First_name.toLowerCase().includes(search.toLowerCase()))
      ...
      <td className="p-2">
        <div className="text-center text-CUSTOM_BLACK">{capitalizeFirstLetter(appointment.userId.First_name)} {capitalizeFirstLetter(appointment.userId.Last_name)}</div>
      </td>
      <td className="p-2">
      ...
      <td className="p-2">
        <div className="text-center  text-CUSTOM_BLACK">{dateFormatterWithoutTime(appointment.appointmentDate)}</div>
      </td>
      <td className="p-2">
